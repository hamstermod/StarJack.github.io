((() => {
    ...
    function userProfile(){
        ...
        userName.forEach(e => {e.innerText = first_name});
    ...
    function spinRoulette() {
        ...
        const randomIndex = isDemo ? Math.floor(Math.random() * (dataGift.length)) + 1 : 11// bug if it's not demo opened recive gift request;
